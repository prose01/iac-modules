...
resource roleAssignment 'Microsoft.Authorization/roleAssignments@2022-04-01' = [for roleDefinitionId in roleDefinitionIds: {
  // name: guid('something', 'reader') Microsoft cannot just use any name so they need a guid ;)
  name: guid(resourceGroup().id, roleDefinitionId, principalId)
  properties: {
    roleDefinitionId: subscriptionResourceId('Microsoft.Authorization/roleDefinitions', roleDefinitionId)
    // principalId: 'cce952a0-10bb-432f-8a13-07b20a0dd412' This is id of App Service or User who needs access
